...
.owl {
  ...
  @include backgroundImage("@/assets/zstp/login/face.png");
  .hand-down-left,
  .hand-down-right {
    z-index: 2;
    position: absolute;
  ...
  .hand-down-left {
    bottom: 3px;
    left: -35px;
    @include backgroundImage("@/assets/zstp/login/hand-down-left.png");
  }
  .hand-down-right {
    bottom: 3px;
    right: -40px;
    @include backgroundImage("@/assets/zstp/login/hand-down-right.png");
  }
  .hand-up-left,
  .hand-up-right {
    z-index: 3;
