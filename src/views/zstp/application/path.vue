  ...
  <div class="searchcontainer">
    ...
    <div class="bottom_bg">
      <div style="text-align: center">
        <el-form ref="form" :model="form" style="display: inline-block; margin-top: 100px">
          <el-form-item style="display: inline-block">
            <input v-model.trim="form.source" class="search_two" placeholder="请输入起点" />
          </el-form-item>

          <el-form-item style="display: inline-block">
            <input v-model.trim="form.target" class="search_two" placeholder="请输入终点" />
          </el-form-item>
        </el-form>
        <el-button type="submit" class="btnsearch_two" @click="loadAcademiesList">
